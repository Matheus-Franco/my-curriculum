      ...
      <Content>
        ...
        <InformationsContainer>
          <Goals focused={focusGoals} id="professionalGoals">
            ...
            <Text>
              Estou em busca de uma primeira colocação no mercado de trabalho
              para que eu possa colocar em prática meus conhecimentos e aprender
              novas tecnologias com pessoas mais experientes.
            </Text>
          </Goals>
